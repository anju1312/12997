...
<div class="navbar">
  ...
  <a href="#">About us</a>
  <a href="#">Contact us</a>  
 <a  class="right" onclick="document.getElementById('id01').style.display='block'">Login</a>  
 
   
 
 <a onclick="myFunction()" class="dropbtn">Sign-Up</a>
  <div id="myDropdown" class="dropdown-content">
    <a  class="dropbtn" href="RegPri.php">Principle</a>
    <a class="dropbtn" href="RegTal.php">Taluka Officer</a>
    <a class="dropbtn" href="RegDis.php">District Officer</a>
  </div>
</div>
...
$h = "SELECT Designation FROM reg where Username= '$Username'";
$result1 = mysqli_query($conn,$h);
if (mysqli_num_rows($result1)== TRUE)
{
$sql = "SELECT uname,Password,Designation FROM reg where Username='$Username' and Password='$Password'";
