...
<div class="navbar">
 ...
 <a onclick="myFunction()" class="dropbtn">Sign-Up</a>
  <div id="myDropdown" class="dropdown-content">
    <a  class="dropbtn" href="RegPri1.php">Principle</a>
    <a class="dropbtn" href="RegTal1.php">Taluka Officer</a>
    <a class="dropbtn" href="RegDis1.php">District Officer</a>
  </div>
</div>
...
class="close" title="Close Modal">&times;</span>
  ...
  <form class="modal-content animate"  method="post" action="login.php">
	...
	<center><img src="nd5.png" alt="Avatar" class="avatar"></center>
      ...
      <input type="password" placeholder="Enter Password" name="pd" required><br>

      <center><input type="submit" value="Login" Name="submit" class="submit"></center><br>
