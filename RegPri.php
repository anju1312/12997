...
$sql ="INSERT INTO Registration (Name,School,School_id, Gender, Password, Designation, Contact_Num, Email, uname)
VALUES ( '$Name','$sname', '$schoolid', '$Gender', '$Password', 'Principal', '$Contact_Num', '$email', '$uname')";
...
<fieldset>
  ...
  <p> <font size=4>Principle Name:</font><br>
...
<font size=4>Gender:</font><br>
 ...
 <p><font size=4>Date of Birth:</font><br> 
  ...
  <input type="text" placeholder="District Name" name="sname" size=30 required></p>
  
  <p> <font size=4>Taluka Name:</font><br>
  <input type="text" placeholder="Taluka Name" name="sname" size=30 required></p>
